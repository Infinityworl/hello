...
async def pm_next_page(bot, query):
    ...
    btn.insert(0, [InlineKeyboardButton(" " 🔥 ʜᴏᴡ ᴛᴏ ᴅᴏᴡɴʟᴏᴀᴅ 🔗", url= "https://t.me/infinityx_Lk")])
...
async def pm_AutoFilter(client, msg, pmspoll=False):    
    ...
    btn.insert(0, [InlineKeyboardButton(text= " 🔥 ʜᴏᴡ ᴛᴏ ᴅᴏᴡɴʟᴏᴀᴅ 🔗", url= "https://t.me/infinityx_Lk")])
    if offset != "":
        key = f"{message.id}"
